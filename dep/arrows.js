...
Arrow.PieChart = function (conf, fn, elem) {
    return new ChartArrow(conf, fn, new PieChart(elem));
};
Arrow.BarChart = function (conf, fn, elem) {
    return new ChartArrow(conf, fn, new BarChart(elem));
};
...
var Chart = function () {
    ...
    _createClass(Chart, [{
        key: 'addListeners',
        value: function addListeners(evt, fn) {
            this.evts[evt] = fn;
        }
    }, {
        key: 'on',
...
var BarChart = function (_Chart2) {
    _inherits(BarChart, _Chart2);
...
var ChartArrow = function (_LiftedArrow2) {
    _inherits(ChartArrow, _LiftedArrow2);
    ...
    function ChartArrow(f, fn, chart) {
        _classCallCheck(this, ChartArrow);

        var _this18 = _possibleConstructorReturn(this, (ChartArrow.__proto__ || Object.getPrototypeOf(ChartArrow)).call(this, function () {
            /* @arrow :: _ ~> Elem */
            return $(chart.elem);
        }));
...
var ComposeError = function (_Error) {
    ...
    function ComposeError(message) {
        ...
        var _this20 = _possibleConstructorReturn(this, (ComposeError.__proto__ || Object.getPrototypeOf(ComposeError)).call(this));
...
var Combinator = function (_Arrow5) {
    ...
    function Combinator(type, arrows) {
        ...
        var _this21 = _possibleConstructorReturn(this, (Combinator.__proto__ || Object.getPrototypeOf(Combinator)).call(this, type));

        _this21.arrows = arrows;
        return _this21;
    }
        ...
        value: function call(x, p, k, h) {
            ...
            this.arrows.forEach(function (a, i) {
                a.call(x[i], p, function (y) {
                    ...
                    if (++numFinished == _this25.arrows.length) {
                        k(callResults);
                    }
                }, h);
            });
    ...
    _createClass(TryCombinator, [{
        ...
        value: function call(x, p, k, h) {
            ...
            this.arrows[0].call(x, branch, function (y) {
                return _this28.arrows[1].call(y, p, k, h);
            }, function (z) {
                branch.cancel();
                _this28.arrows[2].call(z, p, k, h);
            });
        }
    }, {
        key: 'isAsync',
...
var ProxyArrow = function (_Arrow6) {
    ...
    function ProxyArrow(arg, out) {
        ...
        var _this29 = _possibleConstructorReturn(this, (ProxyArrow.__proto__ || Object.getPrototypeOf(ProxyArrow)).call(this, _construct(function () {
...
var TypeClash = function (_Error2) {
    ...
    function TypeClash(type, value) {
        ...
        var _this30 = _possibleConstructorReturn(this, (TypeClash.__proto__ || Object.getPrototypeOf(TypeClash)).call(this));
    ...
    function ArrowType(arg, out, constraints, errors) {
        ...
        try {
            var _loop = function _loop() {
                ...
                if (!_this32.errors.some(function (e) {
                    return e.equals(type);
                })) {
                    _this32.errors.push(type);
                }
            };
...
var ParamType = function (_Type) {
    ...
    function ParamType(id, noreduce) {
        ...
        var _this33 = _possibleConstructorReturn(this, (ParamType.__proto__ || Object.getPrototypeOf(ParamType)).call(this));

        _this33.id = id;
        _this33.noreduce = noreduce;
        _this33.children = [];
        return _this33;
    }
...
var NamedType = function (_Type3) {
    ...
    function NamedType(name) {
        ...
        var _this35 = _possibleConstructorReturn(this, (NamedType.__proto__ || Object.getPrototypeOf(NamedType)).call(this));
...
var SumType = function (_Type4) {
    ...
    function SumType(names) {
        ...
        var _this36 = _possibleConstructorReturn(this, (SumType.__proto__ || Object.getPrototypeOf(SumType)).call(this));

        _this36.names = names.unique().sort();
        return _this36;
    }
...
var TaggedUnionType = function (_Type5) {
    ...
    function TaggedUnionType(map) {
        ...
        var _this37 = _possibleConstructorReturn(this, (TaggedUnionType.__proto__ || Object.getPrototypeOf(TaggedUnionType)).call(this));
    ...
    _createClass(TaggedUnionType, [{
        ...
        value: function isConcrete() {
            ...
            return this.keys.every(function (k) {
                return _this40.vals[k].isConcrete();
            });
        }
    }, {
        key: 'harvest',
        value: function harvest() {
            ...
            return this.keys.reduce(function (acc, k) {
                return acc.concat(_this41.vals[k].harvest());
            }, []);
        }
    }, {
        key: 'substitute',
        value: function substitute(map) {
            ...
            this.keys.forEach(function (k) {
                map[k] = _this42.vals[k].substitute(map);
            });
        ...
        value: function sanitize(map) {
            ...
            var vals = {};
            this.keys.forEach(function (k) {
                vals[k] = _this43.vals[k].sanitize(map);
            });
...
var ArrayType = function (_Type6) {
    ...
    function ArrayType(type) {
        ...
        var _this44 = _possibleConstructorReturn(this, (ArrayType.__proto__ || Object.getPrototypeOf(ArrayType)).call(this));
...
var TupleType = function (_Type7) {
    ...
    function TupleType(types) {
        ...
        var _this46 = _possibleConstructorReturn(this, (TupleType.__proto__ || Object.getPrototypeOf(TupleType)).call(this));
        ...
        value: function check(value) {
            ...
            if (value && value.constructor === Array) {
                value.forEach(function (v, i) {
                    return _this47.types[i].check(v);
                });
            } else {
...
var RecordType = function (_Type8) {
    ...
    function RecordType(map) {
        ...
        var _this48 = _possibleConstructorReturn(this, (RecordType.__proto__ || Object.getPrototypeOf(RecordType)).call(this));

        _this48.vals = map;
        _this48.keys = Object.keys(map).sort();
        return _this48;
    }
    ...
    _createClass(RecordType, [{
        ...
        value: function equals(that) {
            ...
            if (that instanceof RecordType) {
                return this.keys.length === that.keys.length && this.keys.every(function (k) {
                    return _this49.vals[k].equals(that.vals[k]);
                });
            }
        ...
        value: function toString() {
            ...
            return '{' + this.keys.map(function (k) {
                return k + ': ' + _this50.vals[k].toString();
            }).join(', ') + '}';
        }
    }, {
        key: 'check',
        ...
        value: function isConcrete() {
            ...
            return this.keys.every(function (k) {
                return _this52.vals[k].isConcrete();
            });
        }
    }, {
        key: 'harvest',
        value: function harvest() {
            ...
            return this.keys.reduce(function (acc, k) {
                return acc.concat(_this53.vals[k].harvest());
            }, []);
        }
    }, {
        key: 'substitute',
        value: function substitute(map) {
            ...
            var vals = {};
            this.keys.forEach(function (k) {
                vals[k] = _this54.vals[k].substitute(map);
            });
        ...
        value: function sanitize(map) {
            ...
            var vals = {};
            this.keys.forEach(function (k) {
                vals[k] = _this55.vals[k].sanitize(map);
            });
